            ...
            {!isFullScreenPage && (
                <header className="h-16 px-6 border-b border-slate-200 bg-white/95 backdrop-blur-xl sticky top-0 z-10 flex items-center justify-between shadow-sm">
                    ...
                    <div className="flex gap-2">
                        ...
                        <NavLink to="/download" className="px-3 py-1.5 bg-slate-100 text-slate-600 text-xs font-bold rounded-full border border-slate-200 shadow-sm hover:bg-slate-200 transition-colors">
                            Get App
                        </NavLink>
